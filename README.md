...
локальный host или проект требует admission, либо обнаружены его установленная
policy и helper, сначала выполните эту политику. Отсутствующий обязательный
helper/policy блокирует автономную работу; skill не копирует и не обходит
host-правила. Наша managed fleet продолжает использовать свою host-интеграцию.
